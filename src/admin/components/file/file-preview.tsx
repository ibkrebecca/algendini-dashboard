...
import { ActionGroup, ActionMenu } from "@/components/action_menu";
...
export const FilePreview = ({
  ...
  return (
    <div
      className={`shadow-elevation-card-rest bg-ui-bg-component transition-fg rounded-md px-3 py-2 ${className}`}
    >
